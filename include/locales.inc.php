...
function getLocales() {
	return array(
		...
		'it_IT' => array('name' => _('Italian (it_IT)'),	'display' => false),
		'ko_KR' => array('name' => _('Korean (ko_KR)'),		'display' => false),
		'ja_JP' => array('name' => _('Japanese (ja_JP)'),	'display' => false),
		...
		'pt_BR' => array('name' => _('Portuguese (pt_BR)'),	'display' => false),
		'pt_PT' => array('name' => _('Portuguese (pt_PT)'),	'display' => false),
		'ro_RO' => array('name' => _('Romanian (ro_RO)'),	'display' => false),
		'ru_RU' => array('name' => _('Russian (ru_RU)'),	'display' => false),
		'sk_SK' => array('name' => _('Slovak (sk_SK)'),		'display' => false),
